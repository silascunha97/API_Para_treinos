...
3. **Suba o Banco de Dados e a API via Docker:**
```bash
...
4. **Acesse o Playground do GraphQL:**
Abra no seu navegador: `http://localhost:4000/graphql`

---

## 📄 Licença

Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://www.google.com/search?q=LICENSE) para mais detalhes.#   A P I _ P a r a _ t r e i n o s 
 
 